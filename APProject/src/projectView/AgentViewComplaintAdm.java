...
public class AgentViewComplaintAdm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgentViewComplaintAdm frame = new AgentViewComplaintAdm();
	...
	public AgentViewComplaintAdm() {
		...
		exitBttn.setBounds(254, 475, 89, 23);
		...
		public void addUpdateListener (ActionListener listenForUpdateAdmBttn) {
		loadBttn.addActionListener(listenForUpdateAdmBttn);
	}
