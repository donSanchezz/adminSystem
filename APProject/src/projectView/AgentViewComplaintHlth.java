...
public class AgentViewComplaintHlth extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgentViewComplaintHlth frame = new AgentViewComplaintHlth();
	...
	public AgentViewComplaintHlth() {
		...
		public void addUpdateListener (ActionListener listenForUpdateHlthBttn) {
		loadBttn.addActionListener(listenForUpdateHlthBttn);
	}
